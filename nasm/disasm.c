 ...
 */
static unsigned const char *do_ea(unsigned const char *data, int modrm, int asize,
 ...
 */
static int matches(struct itemplate *t, unsigned const char *data, int asize,
                   int osize, int segsize, int rep, insn * ins)
{
    unsigned char *r = (unsigned char *)(t->code);
    unsigned const char *origdata = data;
...
long disasm(unsigned const char *data, char *output, int outbufsize, int segsize,
...
long eatbyte(unsigned const char *data, char *output, int outbufsize)
{
